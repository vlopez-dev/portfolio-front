    ...
    <div class="hero-body">
      <div class="columns mx-2 my-6">
        <div class="column is-full">
          {#key index}
            <p class="title custom-text title-accent" transition:slide>
              <span class="title-text">{greetings[index]}!</span>
            </p>
          {/key}
          <p class="subtitle custom-text-color">Back-end developer</p>
        </div>
      </div>
    </div>
  </section>
